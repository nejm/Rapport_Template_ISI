...
\title{Développement d'une application Web pour l'élaboration d'un dashboard}

\author{Nejm Eddine Hidri}
%%% if necessary
...
\proFramerName{Docteur Mohamed Anis ZEMNI}
\proFramerSpeciality{Doctorant}
...
\companyName{la Société le Monde Informatique}
